...
Econ_data_v4 <- left_join(Econ_data_v4, Remaning_variables, by = c("year", "departement_code"))
...
formula_hetero <- as.formula(X_Y)

bptest(formula_hetero, data = Econ_data_v4, studentize=F)
