...
f_eff_time_2<-plm(entrées~ Farm + Craf_sh_head + Ex_intel + Int_prof + Employees + Workers + Retirees + Ina + factor(year), data=Econ_data_v2, index=c("departement_code", "year"), model="within", effect = "time")
pFtest(f_eff_time_2, f_eff_2)
...
```{r}
f_eff_individual_2<-plm(entrées~ Farm + Craf_sh_head + Ex_intel + Int_prof + Employees + Workers + Retirees + Ina + factor(year), data=Econ_data_v2, index=c("departement_code", "year"), model="within", effect = "individual")
pFtest(f_eff_time_2, f_eff_2)
plmtest(time_effects, effect="individual")
```
