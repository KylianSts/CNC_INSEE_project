...
AE_graph3 <-  recette_AE_nat %>% 
  ...
  geom_line(color = "skyblue", linewidth = 0.75) + 
  labs(title="Totale revenue arthouse cinema in France", x="Year", y="Totale Revenue")+
  theme_classic()
...
AE_graph4 <-  Etablissement_AE %>% 
  ...
  geom_line(color = "purple", linewidth = 0.75) + 
    scale_y_continuous(labels = scales::percent_format(scale = 1)) + 
  labs(titre="Percentage of arthouse cinema in France", x="Year", y="Percentage of Arthouse Cinema")+
  theme_classic()
