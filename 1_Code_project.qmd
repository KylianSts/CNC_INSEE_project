...
Despite a decrease in attendance, we have from 1966 to 1982 increasing revenue (if we look at actualized revenue) due to increasing of price --\> see revenue by ticket.
...
ggplot(merged_data, aes(fill = per_pop_dep_change)) +
  geom_sf() +
  scale_fill_viridis_c(option = "C") + 
  labs(title = "Population Map of France", fill = "Evolution of the relative concentration of the population by department") +
  theme_classic() +
  annotation_scale()+
  annotation_north_arrow(style = north_arrow_nautical, location = "tr", which_north = "true")+
  facet_wrap(~year, ncol = 3)+
...
ggplot(merged_data, aes(fill = per_seats_dep_change)) +
  geom_sf() +
  scale_fill_viridis_c(option = "C") + 
  labs(title = "Population Map of France", fill = "Evolution of the relative concentration of the offer of seats by department") +
  theme_classic() +
  annotation_scale()+
  annotation_north_arrow(style = north_arrow_nautical, location = "tr", which_north = "true")+
  facet_wrap(~year, ncol = 3)+
