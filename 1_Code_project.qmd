...
-    and the a dataset named "**Transformation coefficient from one year's Euro or French Franc to another year's Euro or French Franc – Base 2015**" of Insee : we will use it to adjust past monetary values for inflation.
