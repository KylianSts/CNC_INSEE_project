...
The CNC's data was less memory-consuming. However itsformat was not convenient for coding with R. Indeed, the original XSLX document put each variable in an independent sheet. In the codes below, we merge all this independent sheets into one uniform database.
...
>>>>>>> f95bef95e93f0dc3738a3fe051ca500ad1938fc8
