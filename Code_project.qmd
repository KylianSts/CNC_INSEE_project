...
```{r Cleaning_ormating_unction, message = FALSE}
...
insee_data %>%
  summarize("Number of rows" = prettyNum(nrow(.), big.mark = " "),
            "Number of columns" = ncol(.))%>%
  t() %>%
  knitr::kable(caption = "Description of the Insee_cleanv3 database", format = "html", align='c')
```
...
The main question we aim to answer in this paper is : **"How has the cinema landscape evolved over the last 50 years in France, and what role do sociodemographic factors play in these changes?"**
